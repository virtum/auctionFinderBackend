...
public class ThrottleGuardTest {
    ...
    public void shouldNotAddNewItemAboveLimit() {
        ...
        RequestModel model1 = new RequestModel(null, "test1", "test");
        RequestModel model2 = new RequestModel(null, "test2", "test");
        RequestModel model3 = new RequestModel(null, "test3", "test");
    ...
    public void shouldDelayNextElementsIfLimitIsExceeded() {
        ...
        RequestModel model2 = new RequestModel(null, "test2", "test");
        RequestModel model3 = new RequestModel(null, "test3", "test");
        RequestModel model4 = new RequestModel(null, "test4", "test");
        RequestModel model5 = new RequestModel(null, "test5", "test");
