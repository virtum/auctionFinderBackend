...
@WebServiceClient(name = "serviceService", 
                  wsdlLocation = "file:/C:/Users/pafo/IdeaProjects/auctionFinderBackend/src/main/resources/test.wsdl",
...
public class ServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/pafo/IdeaProjects/auctionFinderBackend/src/main/resources/test.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/C:/Users/pafo/IdeaProjects/auctionFinderBackend/src/main/resources/test.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
