 ...
 *         &lt;element name="filterOptions" type="{https://webapi.allegro.pl/service.php}FutureFilterOptionsStruct" minOccurs="0"/>
...
@XmlRootElement(name = "DoGetMyFutureItemsRequest")
public class DoGetMyFutureItemsRequest {

    @XmlElement(required = true)
    protected String sessionId;
    protected SortOptionsStruct sortOptions;
    protected FutureFilterOptionsStruct filterOptions;
     ...
     * @return
     *     possible object is
     *     {@link FutureFilterOptionsStruct }
     *     
     */
    public FutureFilterOptionsStruct getFilterOptions() {
     ...
     *     
     */
    public void setFilterOptions(FutureFilterOptionsStruct value) {
