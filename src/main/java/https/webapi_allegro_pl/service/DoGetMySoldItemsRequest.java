 ...
 *         &lt;element name="filterOptions" type="{https://webapi.allegro.pl/service.php}SoldFilterOptionsStruct" minOccurs="0"/>
...
@XmlRootElement(name = "DoGetMySoldItemsRequest")
public class DoGetMySoldItemsRequest {

    @XmlElement(required = true)
    protected String sessionId;
    protected SortOptionsStruct sortOptions;
    protected SoldFilterOptionsStruct filterOptions;
     ...
     * @return
     *     possible object is
     *     {@link SoldFilterOptionsStruct }
     *     
     */
    public SoldFilterOptionsStruct getFilterOptions() {
     ...
     *     
     */
    public void setFilterOptions(SoldFilterOptionsStruct value) {
